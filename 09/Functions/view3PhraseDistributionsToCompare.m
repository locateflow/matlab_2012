function view3PhraseDistributionsToCompare(elementMat1, elementMat2, elementMat3, tit1, tit2, tit3)
...
for i = 1:numPhrases  
    ...
    title([tit1, ' - Phrase (', num2str(u(i)), ') Number ', num2str(i), ' out of ', num2str(numPhrases)]);

    subplot(132)
    viewElements2 = subMat2 == u(i);
    imagesc(viewElements2*-1);colormap(bone); 
    title([tit2, ' - Phrase (', num2str(u(i)), ') Number ', num2str(i), ' out of ', num2str(numPhrases)]);
    
    subplot(133)
    viewElements3 = subMat3 == u(i);
    imagesc(viewElements3*-1);colormap(bone); 
    title([tit3, ' - Phrase (', num2str(u(i)), ') Number ', num2str(i), ' out of ', num2str(numPhrases)]);
